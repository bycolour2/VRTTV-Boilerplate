...
export function Home() {
  return (
    <main className="grid min-h-screen place-content-center bg-gradient-to-b from-blue-700 to-blue-800">
      <section className="flex flex-col items-center justify-center gap-5 text-center text-blue-100">
        <h1 className="text-7xl font-bold tracking-wide">
          VRTTV
          <span className="block text-3xl italic">Boilerplate (Remixed)</span>
        </h1>
        ...
        <div className="flex flex-col items-center justify-center gap-2">
          <h3 className="pt-4 text-xl">Added:</h3>
          <p>Tailwind plugins: Typography, Forms, Line-clamp, Aspect-ratio, Class sort</p>
          <p>Packages: Vitest + React testing library</p>
          <p>Config: Some configuration changed</p>
        </div>
        <div className="flex flex-col items-center justify-center gap-2">
          <h3 className="pt-4 text-xl">Removed:</h3>
          <p>Stylelint plugin</p>
        </div>
      </section>
    </main>
  );
